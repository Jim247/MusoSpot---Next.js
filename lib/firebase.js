...
export const createUser = async (email, password, userData) => {
  ...
  await reserveUsername(userData.username, user.uid);
...
export async function reserveUsername(username, uid) {  // Add uid parameter
...
/**
 * Checks if a user has already applied to a specific event.
 * @param {string} eventID - The ID of the event.
 * @param {string} userID - The UID of the user.
 * @returns {Promise<boolean>} True if the user has already applied, false otherwise.
 */
export async function hasUserAppliedToEvent(eventID, userID) {
  const q = query(
...
/**
 * Applies a user to a specific event by creating an application document.
 * @param {string} eventID - The ID of the event.
 * @param {string} userID - The UID of the user.
 * @returns {Promise<string>} The ID of the created application document.
 */
export async function applyToEvent(eventID, userID) {
  const application = {
    eventID,
    userID,
