...
export const MiniMap = memo(
  ({ geopoint, className = 'h-full w-full', id, radius, showCoverage = true }: MiniMapProps) => {
    ...
    useEffect(() => {
      ...
      const timer = setTimeout(() => {
        ...
        const zoomLevel = !shouldShowCoverage
          ? 13
          : Math.min(13, Math.max(8, 13 - Math.log2(radius / 10)));
